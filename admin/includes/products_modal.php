              ...
              <form class="form-horizontal" method="POST" action="products_add.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-5">
                   ...
                   <label for="name" class="col-sm-1 control-label">Seller</label>

                  <div class="col-sm-5">
                    <input type="text" class="form-control" id="name" name="seller" required>
                    <br>
                  </div>
                  ...
                  <label for="photo" class="col-sm-1 control-label">Photo2</label>
